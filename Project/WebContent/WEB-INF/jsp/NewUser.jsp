...
<input type="text" name="newId" style="margin-left:20px"><br>
</p>
...
<p class="center">ユーザ名
<input style="margin-left:35px" type="text" name="userName"><br>
</p>
<p class="center">生年月日
<input type="date" style="margin-left:20px" name="birth"><br>
<p class="center">
<input type="submit" style="margin-top:20px" value="登録">
</form>
